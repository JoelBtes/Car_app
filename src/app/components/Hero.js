...
export default function Hero() {
  ...
  return (
    <section className="h-screen xl:h-[90vh] bg-[#b2b7c7]/10 " id='home'>
        ...
        xl:justify-start h-full">
          ...
          <div className="text-center xl:max-w-xl xl:text-left mt-16 xl:mt-0">
            <motion.h1 variants={fadeIn("down", 0.2)} initial="hidden"
             whileInView={"show"} viewport={{once: false, amount: 0.6 }} className="h1">
              Explore the Finest <span className="text-accent">Global</span> {""}
              Offers
            </motion.h1>
            <motion.p variants={fadeIn("down", 0.4)} initial="hidden"
              whileInView={"show"} viewport={{once: false, amount: 0.6 }} className="description max-w-[550px] mx-auto xl:mx-0 mb-6 xl:mb-10">
      ...
      {searchActive ? (
        ...
        <div className="-mt-2 w-full max-w-[1300px] mx-auto">
        <motion.div 
