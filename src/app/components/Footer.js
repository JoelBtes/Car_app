      ...
      <div className="container mx-auto mb-24">
        ...
        <motion.div
          ...
          <div className="flex flex-col flex-1 gap-y-8">
            ...
            {/* text */}
            <div className="text-secondary">Lorem ispum dolor sit amet, consectetur adipisicing elit.</div>
            {/* phone & email */}
          ...
          <div className="flex-1">
            ...
            <div className="mb-9 text-secondary">Lorem ispum dolor sit amet, consectetur adipisicing elit. 
              Eius recusande, facere facilis in culpa temporibus?</div>
              {/*form*/}
              <form className="flex gap-x-2 h-14">
                <input type="text" placeholder="Your email" className="outline-none 
                bg-white h-full border rounded-lg pl-4 focus:border-acent"/>
